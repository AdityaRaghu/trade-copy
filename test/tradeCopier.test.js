...
test('completeLogin snapshots net positions for the authenticated account', async () => {
  ...
  client.exchangeRequestToken = async () => ({
    ...
    login_time: '2026-04-13 09:15:00',
  });
  client.getPositions = async () => ({
    net: [
      { tradingsymbol: 'NIFTY25APR23500CE', quantity: -65 },
      { tradingsymbol: 'NIFTY25APR23500CE', quantity: -35 },
      { tradingsymbol: 'INFY', quantity: '12' },
      { tradingsymbol: 'IGNORED_ZERO', quantity: 0 },
      { tradingsymbol: '', quantity: 99 },
    ],
  });
